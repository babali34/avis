    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button type="button" class="btn btn-link slick-arrow slick-prev mobdis" id="asd"><i class="fa fa-angle-left"></i></button>',
                nextArrow: '<button type="button" class="btn btn-link slick-arrow slick-next mobdis" id="asdasd"><i class="fa fa-angle-right"></i></button>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
